...
//        showUnselectedLabels: false,
        items: [
          BottomNavigationBarItem(
            ...
            title: Text('Learn',  style: TextStyle( fontSize: 10.0, color: _selectedIndex == 0 ? Color(0XFF9D1000): Color(0XFF9A9A9A))),
          ),
          BottomNavigationBarItem(
            icon: SvgPicture.asset("assets/images/progress.svg",
              color: _selectedIndex == 1 ? Color(0XFFF48C02): Color(0XFF9A9A9A)
            ),
            title: Text('Progress', style: TextStyle(fontSize: 10.0, color: _selectedIndex == 1 ? Color(0XFF9D1000): Color(0XFF9A9A9A))),
          ),
          BottomNavigationBarItem(
            icon: SvgPicture.asset("assets/images/notification.svg",
              color: _selectedIndex == 2 ? Color(0XFFF48C02): Color(0XFF9A9A9A)
            ),
            title: Text('Notifications', style: TextStyle(fontSize: 10.0, color: _selectedIndex == 2 ? Color(0XFF9D1000) : Color(0XFF9A9A9A))),
          ),
          BottomNavigationBarItem(
            icon: SvgPicture.asset("assets/images/profile.svg",
              color: _selectedIndex == 3 ? Color(0XFFF48C02): Color(0XFF9A9A9A)
            ),
            title: Text('Profile', style: TextStyle(fontSize: 10.0, color: _selectedIndex == 3 ? Color(0XFF9D1000): Color(0XFF9A9A9A))),
          ),
