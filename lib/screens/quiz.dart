...
enum TestType{
  ToEnglish, ToIgbo, Sentence, Match, None
}
                        ...
                        isFinished()
                          ...
                          child: isLoading
                            ...
                            AlwaysStoppedAnimation<Color>(
                              ...
                              : Text('Continue', style: TextStyle(color: Colors
                              .white),),
                        )
                            :
                        FlatButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: Padding(
          padding:
          EdgeInsets.only(top: 30.0, left: 20.0, right: 20.0, bottom: 5.0),
          child: Column(
              children: <Widget>[
                Row(
                  children: <Widget>[
...
//                                                    print('optionD: $optionD');
                                        ...
                                        children: <Widget>[
                                          ...
                                          Container(
                                              ...
                                              child: Column(
                                                children: <Widget>[
                                                  Image(
                                                    image: NetworkImage("${widget.lessons[number]['test'][testNumber]['matchQuestionImage']}"),
                                                  ),
                                                  SizedBox(height: 5,),
                                                  Text('${widget.lessons[number]['test'][testNumber]['matchQuestion']}', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w600),)
                                                ],
                                              )
                   ...
                   display == SectionDisplay.Learn ? Row(
                      ...
                      onTap: () {
                        setState(() {
                          if(widget.lessons[number]['test'] == [] || widget.lessons[number]['test'].length == 0 ){
                            ...
                            testType = _getTestType(widget.lessons[number]['test'][testNumber]['type']);
                          }
                        });
                      },
                      child: SvgPicture.asset(
