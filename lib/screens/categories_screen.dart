              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child:  ListView(
                      ...
                      padding:
                      EdgeInsets.only(top: 30.0, left: 15.0, right: 15.0, bottom: 20.0),
                      child: Column(
                            ...
                            children: <Widget>[
                              Container(
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: Color(0XFFB5B5B5), width: 0.4),
                                    color: Colors.white),
                                child: Column(
                                  children: <Widget>[
                                    Container(
                                ...
                                children: <Widget>[
                                  Container(
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(5),
                                        border: Border.all(
                                            color: Color(0XFFF21600), width: 0.7),
                                        color: Colors.white),
                                    child: Column(
                                      children: <Widget>[
                                        Container(
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    color: Color(0XFFF21600), fontSize: 13.0),
                              ),
                            ],
                          ),
                          SizedBox(
