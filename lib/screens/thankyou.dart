                  ...
                  SafeArea(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(height: 20,),
                          SizedBox(height: 30,),
                          Text('Click continue to learn again or start a new lesson', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 18, )),
                          SizedBox(height: 30,),
                          FlatButton(
